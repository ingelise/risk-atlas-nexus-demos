...
| [Auto-BenchmarkCard](https://github.com/IBM/ai-atlas-nexus-demos/tree/main/auto-benchmarkcard) | benchmark documentation, LLM, risk identification, fact-checking | **(Archived. Moved to [evaleval/auto-benchmarkcard](https://github.com/evaleval/auto-benchmarkcard).)** Automated workflow for generating validated AI benchmark documentation with multi-agent data extraction, LLM-driven synthesis, and factuality verification.|
...
| [Risk-to-Code Traceability](https://github.com/IBM/ai-atlas-nexus-demos/tree/main/risk_code_traceability) | RDF-star, pyoxigraph, LinkML, risk detection | Links Graphify-extracted code artifacts to AI Atlas Nexus risks via a keyword/embedding/LLM pipeline, stored as an RDF-star graph. |
